...
def load_dataset(name):
    ...
    celeba_root_dir = '/content/VAEAC_Thesis/data/vaeac_project'  # change it for your system!
    ...
    if name == 'celeba_train':
        # Restrict train set to 10000 samples for fast debugging
        return LengthBounder(CelebA(
            celeba_img_dir,
            celeba_partition,
            'train',
            celeba_transforms), 15000)
